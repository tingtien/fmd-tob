...
class Index extends Component {
  ...
  componentDidMount() {
    ...
    container.addEventListener('click', this.showStar);
  }
  ...
  componentWillUnmount() {
    ...
    timeline.reset();
    const container = document.querySelector('.ant-layout-content');
    container.removeEventListener('click', this.showStar);
  }

  render() {
    return (
      <div id="welcome" className={styles.welcome}>欢迎访问FM Design Tob</div>
    );
  }
}
